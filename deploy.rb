...
set :scm, :git
set :repository, "git@github.com:exactreal/railsapp.git"
set :branch, "master"
...
role :web,      "ec2-184-73-146-245.compute-1.amazonaws.com"
role :app,      "ec2-184-73-146-245.compute-1.amazonaws.com"
role :db,       "ec2-184-73-146-245.compute-1.amazonaws.com", :primary => true
role :memcache, "ec2-184-73-146-245.compute-1.amazonaws.com"
...
set :ec2onrails_config, {
  ...
  #:rubygems => ["mislav-will_paginate -v 2.3.8", "ya2yaml", "json", "jpignata-bossman"],
...
set :nonvc_configs, ['config/s3.yml', 'config/database.yml']
